setTimeout(() => {
  document.querySelector('.bodyMain').classList.remove('bodyContent');
  document.querySelector('.bodydiv1').classList.remove('bodydiv');
  document.querySelector('.loading').classList.add('loading2');
}, 3000);
// MENU SHOW Y HIDDEN
